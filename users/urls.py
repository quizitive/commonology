...
from users.forms import PwdResetForm, NewPwdForm
...
urlpatterns = [
    ...
    path("players/<int:player_id>", views.PlayerStatsView.as_view(), name="player-view"),
    ...
    path(
        "reset/<uidb64>/<token>/",
        views.PwdResetConfirmView.as_view(form_class=NewPwdForm),
